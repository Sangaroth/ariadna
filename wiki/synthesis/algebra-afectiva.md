---
page_id: algebra-afectiva
page_type: synthesis
synthesis_subtype: author_thesis
auto_promoted_synthesis: true
canonical_name: Álgebra afectiva
aliases:
- algebra afectiva
- álgebra afectiva
- sistema lógico-formal de los afectos
- operaciones entre clases cognitivas
...
- type: extends
  ...
  weight: canonical
  note: el álgebra afectiva formaliza las operaciones entre los siete motores afectivos
    que la teoría de las emociones del canal describe; aquí se sistematizan como sistema
    lógico-formal entre clases cognitivas
- type: extends
  to: realismo-cognitivo
  weight: canonical
  note: 'el speaker declara que el álgebra afectiva es aplicación directa del realismo
    cognitivo: si una operación cognitiva es expresable matemáticamente, ambos son
    la misma cosa, y las producciones culturales recapitulan los fundamentos de la
    mente'
- type: compared_with
  to: teoria-del-simbolo-en-proxy
  weight: strong
  note: 'la descomposición 3Q (gramatical-afectiva-imaginaria) opera al mismo nivel
    que la teoría del símbolo: toda representación mental se descompone en estos tres
    registros'
- type: see_also
  to: clases-ancestrales
  weight: strong
  note: los siete motores afectivos son redes biológicas universales filogenéticamente
    compartidas — clases cognitivas de origen ancestral
- type: see_also
  to: golem-de-cobre
  weight: weak
  note: 'el marco del realismo cognitivo expuesto en golem-de-cobre se prolonga aquí
    en su versión formal: cómo se opera matemáticamente entre afectos'
- type: compared_with
  to: collective-unconscious
  weight: weak
  note: la cualia universal de las clases cognitivas se solapa con las estructuras
    transpersonales del inconsciente colectivo, aunque el canal lo articula como red
    biológica filogenética, no como herencia simbólica
- type: see_also
  to: individuation
  weight: weak
  note: el equilibrio entre las dos triadas (estrés y ansiedad) y el eje aprender-enseñar
    tiene paralelo con el proceso de integración psíquica
sources_count: 1
...
El canal propone el **álgebra afectiva** como el sistema lógico-formal que establece relaciones entre **clases cognitivas** — donde una clase cognitiva es la unidad mínima de cualia universal, la parte de la experiencia subjetiva compartida por todos los miembros de la especie. Una **operación afectiva** es el cambio de estado del yo de t₀ a t+1 en la noesis: transitar de no-pánico a pánico, componer dos estados, contraponerlos en ambivalencia. Lo decisivo es que estas operaciones admiten formalización matemática, y por eso pertenecen al mismo orden que las matemáticas mismas.

La tesis se inscribe explícitamente como prolongación del [[realismo-cognitivo]]: si una operación cognitiva es expresable matemáticamente, entonces el proceso cognitivo y la matemática son la misma cosa, porque las matemáticas son una meta-formalización. Sobre esa base el speaker articula los **siete motores afectivos biológicos** (buscar, terror, ira, jugar, desear, apego, pánico) y los organiza en dos **triadas** funcionales —estrés y ansiedad—, ancladas en dos **ejes biológicos** (temporal: nacer-morir; cultural: aprender-enseñar) y ordenadas filogenéticamente desde la ameba al mamífero. La estructura no es taxonómica sino operatoria: describe cómo el aparato afectivo opera, se compone y se desequilibra, con consecuencias clínicas directas para TDAH, psicopatía y autismo.

## Estructura del marco

- **Clase cognitiva como unidad mínima de cualia universal**: la parte universal de la experiencia subjetiva, la unidad básica que el álgebra opera. Toda clase cognitiva existe por oposición a otras clases — no hay clase aislada.
- **Operación afectiva como cambio de estado del yo**: transición en la noesis de t₀ a t+1. Es el verbo del sistema: lo que el álgebra describe formalmente. Toda operación cognitiva está orientada al desarrollo en el mundo, incluso las oníricas y psicóticas.
- **Las tres componentes 3Q de toda representación mental**: gramatical (relaciones abstractas: sujeto-objeto, transiciones, cero, infinito), afectiva (la valencia de significación: hogar = casa + no-pánico; en trauma, casa = terror) e imaginaria (forma, color, espacio: el magenta como invención mental que no existe como frecuencia lumínica).
- **Siete motores afectivos — buscar**: motor de exploración orientada al mundo. Su disfunción es central en el TDAH leído como problema de buscar, no de afectos.
- **Siete motores afectivos — terror**: red biológica de respuesta a la amenaza inmediata. Pieza de la triada del estrés.
- **Siete motores afectivos — ira**: motor de confrontación y defensa. Tercera pieza de la triada del estrés.
- **Siete motores afectivos — jugar**: red biológica del aprendizaje exploratorio y la afiliación lúdica, separada de las dos triadas patológicas.
- **Siete motores afectivos — desear**: motor del vínculo apetitivo. Pieza de la triada de la ansiedad.
- **Siete motores afectivos — apego**: red biológica del vínculo estable. Pieza de la triada de la ansiedad y eje afectado en autismo.
- **Siete motores afectivos — pánico**: red biológica encargada del conjunto de emociones que conforman la vivencia de abandono. Pieza de la triada de la ansiedad y eje afectado en autismo.
- **Triada del estrés (buscar-terror-ira)**: núcleo de los afectos activos en disfunción energética; agrupa los motores que se accionan ante la amenaza y el déficit.
- **Triada de la ansiedad (apego-pánico-deseo)**: núcleo de los afectos vinculares en disfunción; agrupa los motores que articulan el vínculo y su pérdida.
- **Eje temporal y eje cultural de la función biológica**: el eje temporal va de nacimiento a muerte; el eje cultural va de aprender a enseñar. Enseñar es genuinamente humano y requiere universalizar mediante lenguaje — los simios aprenden pero no enseñan propiamente.
- **Filogénesis de los afectos — de la ameba al mamífero**: los siete motores aparecen en un orden evolutivo determinado, lo que explica por qué unos son más arcaicos y otros más recientes en el aparato cognitivo.
...
> "El álgebra afectiva describe formalmente las operaciones entre afectos"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (25:16)](https://youtu.be/BdVsvhTWWew?t=1516)

> "Tesis central del realismo cognitivo: todas las producciones culturales recapitulan los fundamentos de la mente humana"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (17:11)](https://youtu.be/BdVsvhTWWew?t=1031)

> "Toda representación mental se descompone en tres componentes: gramatical, afectiva e imaginaria"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (37:05)](https://youtu.be/BdVsvhTWWew?t=2225)

> "Una operación mental es el cambio de estado del yo de t₀ a t+1 en la noesis"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (09:37)](https://youtu.be/BdVsvhTWWew?t=577)

> "Las matemáticas son una meta-formalización: si expresan un proceso cognitivo, ambos son la misma cosa"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (17:11)](https://youtu.be/BdVsvhTWWew?t=1031)

> "Pánico: red biológica encargada del conjunto de emociones que conforman la vivencia de abandono"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (22:14)](https://youtu.be/BdVsvhTWWew?t=1334)

> "Los afectos no son sensaciones ni emociones; las emociones son la traducción somática corporal de un afecto"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (43:10)](https://youtu.be/BdVsvhTWWew?t=2590)

> "Eje temporal: de nacimiento a muerte; eje cultural: de aprender a enseñar"
→ [Psicología 101: Valencia y emoción. Álgebra afectiva (29:30)](https://youtu.be/BdVsvhTWWew?t=1770)

## Páginas conectadas

- [[teoria-de-las-emociones-en-proxy]] — el álgebra afectiva es la formalización operatoria de la teoría de emociones del canal: aquí los siete motores se articulan como sistema con composición y oposición, no solo como inventario
- [[realismo-cognitivo]] — el marco se declara explícitamente como aplicación del realismo cognitivo (toda producción cultural recapitula la mente; lo expresable matemáticamente ES matemático)
- [[teoria-del-simbolo-en-proxy]] — la descomposición 3Q (gramatical/afectivo/imaginario) actúa como teoría unificada de toda representación mental, en paralelo con la teoría del símbolo
- [[clases-ancestrales]] — los siete motores son redes biológicas filogenéticamente universales: la ordenación de la ameba al mamífero los inscribe como clases ancestrales del aparato cognitivo
- [[golem-de-cobre]] — prolongación natural del marco del realismo cognitivo expuesto allí, ahora en versión formal-operatoria
- [[collective-unconscious]] — la cualia universal de las clases cognitivas tiene parentesco con las estructuras transpersonales junguianas, aunque el canal las articula como redes biológicas, no como herencia simbólica
- [[individuation]] — el equilibrio entre triada de estrés y triada de ansiedad, y entre los ejes nacer-morir y aprender-enseñar, se solapa funcionalmente con la idea junguiana de integración psíquica

## Lagunas

- El canal nombra los **siete motores** y las **dos triadas** pero no detalla las **operaciones formales** específicas (composición, contraposición, suma de afectos) más allá de su mención como posibilidad — falta el cálculo concreto del álgebra
- La pieza **jugar** queda fuera de las dos triadas patológicas sin que el speaker articule explícitamente su rol estructural en el sistema (¿es la operación que estabiliza? ¿la que abre la enseñanza?)
...
Esta página se ha auto-promovido al cumplir el gate de scope.md §2.4.1 (minutes_sustained=95, signal_marks_detected=5, framework_internal_structure=16 piezas). Queda abierta a revisión humana — el campo `auto_promoted_synthesis: true` en frontmatter es la marca de auditoría. Una segunda pasada con material de vídeos adyacentes sobre teoría de emociones, clases ancestrales y realismo cognitivo permitiría enriquecer el desarrollo formal del álgebra y cerrar las lagunas señaladas.
