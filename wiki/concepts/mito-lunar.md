...
- type: compared_with
  to: mito-solar
  weight: canonical
  note: Dipolo simétrico con secuencias inversas; los dos mitos propios primarios
    cuya conjunción genera el polar
- type: synthesized_in
  to: mito-polar
  weight: canonical
  note: El mito polar es la superposición del solar y el lunar
- type: compared_with
  to: hieros-gamos
  weight: strong
  note: La conjunción solar-lunar en el mito polar tiene correspondencia interior
    con el hieros gamos
- type: see_also
  to: genesis-mitologico
  weight: strong
  note: El génesis es otro de los seis mitos primarios del sistema cosmológico de
    Proxy
- type: see_also
  to: uranico-telurico-cetonico
  weight: strong
  note: El esquema uránico-ctónico-telúrico es el marco espacial en que se inscriben
    los mitos primarios
sources_count: 1
...
## Definición y secuencia canónica

El mito lunar es uno de los **seis mitos propios primarios** del sistema cosmológico que el canal articula en el libro *Del origen del mal*. Es el mito del principio femenino cíclico — la diosa lunar — en contraposición al [[mito-solar]], que articula el principio masculino cíclico.
...
La secuencia del mito lunar consta de cinco fases:

1. **Despertar** (*égersis*) — el inicio del ciclo; el principio femenino que emerge de la oscuridad
2. **Creación** — la potencia generadora de la diosa como principio cosmogónico
3. **Caída** — el descenso; la pérdida del estado original
4. **Luna roja** — la fase de crisis; el momento de mayor oscuridad del ciclo
5. **Exorcismo** — la purificación que cierra el ciclo; el retorno

## Contraste estructural con el mito solar

El mito solar y el lunar forman un dipolo simétrico con secuencias de sentido inverso:

| Mito solar | Mito lunar |
|---|---|
| Caída | Despertar |
| Camino | Creación |
| Muerte | Caída |
...
El mito solar habita el polo uránico (celeste, luminoso, ascendente); el mito lunar habita el polo ctónico (subterráneo, oscuro, profundo). La triada [[uranico-telurico-cetonico]] es el marco espacial en que se inscriben los movimientos de ambos mitos primarios.

## Relación con el mito polar

> "El mito polar es la superposición del solar y el lunar"
→ [Directo doble Parte 1: La IA demuestra la semántica no explícita (1:16:22)](https://youtu.be/t8v5w3s0USA?t=4582)

El [[mito-polar]] no es un tercer mito independiente sino la **superposición** de los dos mitos primarios. La conjunción del principio solar masculino y el principio lunar femenino produce la estructura polar — el "tercer camino" transformador del sistema cosmológico del canal. Esta superposición tiene correspondencia con el [[hieros-gamos]] como dinámica psíquica: la unión sagrada de los opuestos que genera algo cualitativamente distinto a cada polo por separado.
